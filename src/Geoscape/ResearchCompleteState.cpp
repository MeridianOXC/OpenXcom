 ...
 */
ResearchCompleteState::ResearchCompleteState(const RuleResearch *newResearch, const RuleResearch *bonus, const RuleResearch *research, const std::string baseName) : _baseName(baseName), _research(newResearch), _bonus(bonus)
{
	_screen = false;
	...
	_txtBaseName = new Text(110,17,105, 125);
	...
	add(_txtBaseName, "text1", "geoResearchComplete");
