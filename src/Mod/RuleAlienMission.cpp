...
bool read(ryml::ConstNodeRef const& n, MissionWave* val)
{
	...
	reader.readN("objective", val->objective, false);
	reader.readN("objectiveOnTheLandingSite", val->objectiveOnTheLandingSite, false);
	reader.readN("objectiveOnXcomBase", val->objectiveOnXcomBase, false);
	reader.readN("hunterKillerPercentage", val->hunterKillerPercentage, -1);
	reader.readN("huntMode", val->huntMode, -1);
	reader.readN("huntBehavior", val->huntBehavior, -1);
	reader.readN("escort", val->escort, false);
	reader.readN("interruptPercentage", val->interruptPercentage, 0);
